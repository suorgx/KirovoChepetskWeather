    ...
    onMount(async () => {
        ...
        new Chart(ctx, {
            ...
            options: {
                ...
                scales: {
                    x: { ticks: { autoSkip: true, maxRotation: 55, minRotation: 55 } },
                    y: { beginAtZero: true }
                },
            },
            plugins: [{
...
<div class="grid grid-cols-3 gap-6 p-6">
    ...
    <div class="col-span-2 bg-white rounded-2xl shadow p-6">
        ...
        <div class="bg-gradient-to-t from-blue-100 to-blue-50 rounded-lg flex items-center justify-center text-gray-400">
